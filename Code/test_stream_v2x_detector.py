...
def save_global_results_to_json(file_path = "global_frame_result.json"):
    """
...
class StreamV2XDetector:
    ...
    def __init__(self, model_path="/home/nebula/RGB-LIDAR-fusion/Code/yolov8m-seg.pt", tracking=True, view_prefix=""):
